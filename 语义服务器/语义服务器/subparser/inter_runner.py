import os
from 语义服务器.subparser.identity_table import TableItem, Table
from 语义服务器.subparser.forms import Quadruple
from 语义服务器.subparser.ParseErrData import RTM_ERR, ParseErrData
