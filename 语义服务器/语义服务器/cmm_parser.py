import sys, getopt
from 语义服务器.subparser.sig_table import get_key
...
from 语义服务器.subparser.inter_runner import InterRunner
...
class CmmParser(object):
    ...
    def parse(self, code, ofilename=None, show_lex=False, show_syntax=False, file_name=None, draw_graph=False, checkpoints=[]):
        code_str = code
